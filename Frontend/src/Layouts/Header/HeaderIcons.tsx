  ...
  return (
    <>
      ...
      <div className="hidden md:flex items-center gap-1 sm:gap-2">
        <WalletIcon />
        <Link to="/voucher" className="flex items-center gap-1 hover:text-[#4B5563] transition-all duration-300 group">
      ...
      <Link to="/cart" className="relative flex items-center gap-1 hover:text-[#4B5563] transition-all duration-300 group">
      ...
      <Link to="/message" className="flex items-center gap-1 hover:text-[#4B5563] transition-all duration-300 group">
        <div className="relative">
