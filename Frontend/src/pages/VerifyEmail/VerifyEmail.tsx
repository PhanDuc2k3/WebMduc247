        ...
        <div className="w-full max-w-md bg-white rounded-2xl sm:rounded-3xl shadow-2xl border-2 border-gray-100 p-4 sm:p-6 md:p-8 lg:p-10 relative animate-fade-in-up">
          ...
          <div className="relative">
            <button
              ...
              className="mb-4 flex items-center gap-2 text-gray-600 hover:text-[#4B5563] transition-colors"
            >
            ...
            <div className="text-center mb-4 sm:mb-6">
              <div className="w-12 h-12 sm:w-16 sm:h-16 bg-[#4B5563]/10 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                <Mail className="w-6 h-6 sm:w-8 sm:h-8 text-[#4B5563]" />
              </div>
              ...
              <p className="text-[#4B5563] font-semibold mt-1 text-sm sm:text-base break-all px-2">{email}</p>
            </div>
            ...
            <form className="space-y-4 sm:space-y-5" onSubmit={handleVerify}>
              <div>
                ...
                <div className="relative">
                  <input
                    type="text"
                    className="w-full px-3 sm:px-4 py-2.5 sm:py-3 text-center text-xl sm:text-2xl font-bold tracking-widest border-2 border-gray-200 rounded-lg sm:rounded-xl focus:ring-2 focus:ring-[#4B5563] focus:border-[#4B5563] outline-none bg-white transition-all duration-300"
                    placeholder="000000"
            ...
            <div className="mt-4 sm:mt-6 pt-4 sm:pt-6 border-t border-gray-200">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-3 sm:px-4 py-2 sm:py-2.5 text-[#4B5563] border-2 border-[#4B5563] rounded-lg sm:rounded-xl hover:bg-[#4B5563]/10 transition-all duration-300 font-semibold text-xs sm:text-sm disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {resendLoading ? (
                  <>
                    <span className="w-3.5 h-3.5 sm:w-4 sm:h-4 border-2 border-[#4B5563] border-t-transparent rounded-full animate-spin"></span>
                    <span>Đang gửi...</span>
                  </>
                ) : countdown > 0 ? (
                  <>
