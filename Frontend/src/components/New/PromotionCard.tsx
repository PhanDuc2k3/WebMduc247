...
const PromotionCard: React.FC<PromotionCardProps> = ({
  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl border-2 border-gray-100 overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 group animate-fade-in-up">
      {/* Hình ảnh */}
      ...
      <div className="p-6">
        ...
        {/* Mô tả */}
        <p className="text-sm text-gray-700 mb-4 leading-relaxed font-medium">{description}</p>
