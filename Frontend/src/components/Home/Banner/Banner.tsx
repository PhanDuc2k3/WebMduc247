...
const Banner: React.FC = () => {
  return (
    <div className="flex flex-col lg:flex-row gap-4 lg:gap-8 mt-8">
      {/* Banner chính */}
      <div className="lg:flex-[2] relative rounded-2xl overflow-hidden w-full group flex lg:max-h-[380px]">
        <img
      ...
      <div className="lg:flex-1 flex flex-col gap-4 lg:gap-6">
        {/* Flash Sale */}
        <div className="flex-1 relative rounded-2xl overflow-hidden w-full group lg:max-h-[180px]">
          <img
          ...
          <div className="absolute inset-0 bg-black/30 flex flex-col justify-end p-4 text-white transition duration-500 ease-out group-hover:bg-black/50">
            <div className="text-lg lg:text-xl font-bold opacity-90">
              Flash Sale
            </div>
            <div className="text-sm lg:text-base my-2 opacity-80">
              Kết thúc trong 2h:15p
            </div>
            <button className="bg-white text-[#ff7e5f] px-3 lg:px-4 py-2 rounded-lg font-semibold hover:opacity-90 transition duration-300 text-sm lg:text-base group-hover:scale-110">
              Xem ngay
            </button>
          </div>
        </div>
        ...
        <div className="flex-1 relative rounded-2xl overflow-hidden w-full group lg:max-h-[180px]">
          ...
          <div className="absolute inset-0 bg-black/30 flex flex-col justify-end p-4 text-white transition duration-500 ease-out group-hover:bg-black/50">
            ...
            <button className="bg-white text-[#00c6fb] px-3 lg:px-4 py-2 rounded-lg font-semibold hover:opacity-90 transition duration-300 text-sm lg:text-base group-hover:scale-110">
              Mua sắm
            </button>
          </div>
        </div>
