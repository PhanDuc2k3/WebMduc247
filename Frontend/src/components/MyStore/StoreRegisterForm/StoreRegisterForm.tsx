  ...
  return (
    <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg max-w-xl mx-auto p-4 sm:p-6 md:p-8">
      <div className="flex flex-col items-center mb-4 sm:mb-6">
        <div className="bg-[#4B5563] rounded-full w-12 h-12 sm:w-16 sm:h-16 flex items-center justify-center mb-2">
      ...
      <form onSubmit={handleSubmit}>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mb-4">
          <div>
            ...
            <input
              ...
              className="w-full border rounded-lg px-3 py-2 text-sm sm:text-base bg-gray-50 focus:outline-none focus:ring-2 focus:ring-[#4B5563] focus:border-transparent"
        ...
        {/* Ghi chú */}
        <div className="bg-[#4B5563]/10 border border-[#4B5563]/40 rounded-lg p-3 sm:p-4 text-xs sm:text-sm text-gray-700 mb-4 sm:mb-6">
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
          <button
            type="submit"
            className="flex-1 bg-[#4B5563] text-white font-semibold py-2.5 sm:py-3 rounded-lg hover:bg-[#374151] transition text-sm sm:text-base"
          >
