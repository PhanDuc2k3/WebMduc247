...
const StoreInfo: React.FC<Props> = ({
  ...
  return (
    <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg border border-[#4B5563]/30 p-4 sm:p-6 lg:p-8 animate-fade-in-up">
      <div className="mb-4 sm:mb-6">
        <h2 className="text-xl sm:text-2xl font-bold text-[#4B5563] mb-1">Thông tin cửa hàng</h2>
      ...
      <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 lg:gap-8">
        ...
        <div className="flex flex-col items-center gap-4 sm:gap-6 w-full lg:w-1/3">
          <div className="w-full">
            ...
            <div
              className="w-full h-32 sm:h-40 lg:h-48 rounded-lg sm:rounded-xl overflow-hidden cursor-pointer border-2 border-dashed border-[#4B5563]/40 hover:border-[#4B5563] active:border-[#374151] transition-all duration-300 group relative touch-manipulation"
          ...
          <div className="w-full flex flex-col items-center">
            ...
            <div
              className="w-24 h-24 sm:w-32 sm:h-32 rounded-full overflow-hidden cursor-pointer border-4 border-[#4B5563]/40 hover:border-[#4B5563] active:border-[#374151] transition-all duration-300 shadow-lg group relative touch-manipulation"
        ...
        <div className="flex-1 flex flex-col gap-4 sm:gap-5">
          ...
          <div className="pt-1 sm:pt-2">
            <button
              className="w-full sm:w-auto px-5 sm:px-6 py-2.5 sm:py-3 text-sm sm:text-base bg-[#4B5563] text-white rounded-lg sm:rounded-xl font-bold shadow-lg hover:shadow-xl hover:bg-[#374151] active:scale-95 sm:hover:scale-105 transition-all duration-300 flex items-center justify-center gap-2 touch-manipulation"
