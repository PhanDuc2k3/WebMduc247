...
const ProductTabs: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-screen-xl mx-auto mt-10">
      {/* Thanh chọn tab */}
<div className="flex space-x-3 bg-gray-100 p-0.5 rounded-full w-fit px-1 mb-6">
  {tabs.map((tab) => (
    <button
      key={tab.id}
      onClick={() => setActive(tab.id)}
      className={`px-5 py-0.5 text-sm font-medium rounded-full border transition-colors duration-200
        ${
          active === tab.id
    ...
    >
      ...
      {/* Nội dung tab */}
      <div className="p-6 bg-white border rounded-b-lg shadow text-sm text-gray-800 leading-relaxed">
        {active === "mo-ta" && (
          <>
            <p className="mb-3">
              iPhone 15 Pro Max là đỉnh cao của công nghệ di động với chip A17 Pro mạnh mẽ và hệ thống
              camera tiên tiến. Thiết kế titan cao cấp mang đến sự bền bỉ và sang trọng.
            </p>
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-700 text-sm mt-1">
              Sản phẩm tuyệt vời, chất lượng đúng như mô tả. Giao hàng nhanh,
              đóng gói cẩn thận.
            </p>
