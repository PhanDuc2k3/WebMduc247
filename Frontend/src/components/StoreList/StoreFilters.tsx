      ...
      <div className="flex flex-col sm:flex-row flex-wrap gap-2 md:gap-3 lg:gap-4">
        ...
        >
          <button
            ...
            className="w-full flex justify-between items-center border-2 border-gray-200 rounded-lg md:rounded-xl px-3 py-2 md:px-4 md:py-3 bg-white text-xs md:text-sm text-gray-700 hover:border-[#4B5563] hover:shadow-md focus:outline-none transition-all duration-300 shadow-sm touch-manipulation"
          >
            ...
            <ChevronDown
              className={`w-3 h-3 md:w-4 md:h-4 text-gray-400 transition-transform duration-300 flex-shrink-0 ml-2 ${ratingOpen ? "rotate-180 text-[#4B5563]" : ""}`}
            />
          </button>
          {ratingOpen && (
            <div 
            ...
            >
              {ratingOptions.map((opt) => (
                <div
                  ...
                  className="px-3 py-2 md:px-4 md:py-3 text-xs md:text-sm text-gray-700 hover:bg-[#4B5563]/10 hover:text-[#4B5563] cursor-pointer transition-all duration-200 font-medium"
                >
                  {opt}
                </div>
              ))}
        ...
        >
          ...
          >
            ...
            <ChevronDown
              className={`w-3 h-3 md:w-4 md:h-4 text-gray-400 transition-transform duration-300 flex-shrink-0 ml-2 ${regionOpen ? "rotate-180 text-[#4B5563]" : ""}`}
            />
          </button>
          {regionOpen && (
            <div 
        ...
        >
          ...
          >
            ...
            <ChevronDown
              className={`w-3 h-3 md:w-4 md:h-4 text-gray-400 transition-transform duration-300 flex-shrink-0 ml-2 ${categoryOpen ? "rotate-180 text-[#4B5563]" : ""}`}
            />
          </button>
          {categoryOpen && (
            <div 
