...
const ProfileSettings: React.FC<ProfileSettingsProps> = ({
    ...
    return (
      <div className="bg-white rounded-xl md:rounded-2xl shadow-lg border-2 border-gray-100 p-4 md:p-6 lg:p-8">
        <div className="flex items-center justify-between mb-4 md:mb-6">
          <h3 className="font-semibold text-lg sm:text-xl text-[#4B5563]">Quản lý địa chỉ</h3>
          <button
  ...
  return (
    <div className="bg-white rounded-xl md:rounded-2xl shadow-lg border-2 border-gray-100 p-4 md:p-6 lg:p-8">
      <h3 className="font-semibold text-lg sm:text-xl mb-4 md:mb-6 text-[#4B5563]">Cài đặt tài khoản</h3>
      <div className="space-y-3 md:space-y-4 lg:space-y-6">
        {/* Email Notifications */}
        <div className="border-2 border-[#4B5563]/15 rounded-lg md:rounded-xl p-4 md:p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 md:gap-4">
          <div className="flex-1 min-w-0">
            <div className="text-sm sm:text-base md:text-lg font-medium mb-1 flex items-center gap-2">
              <Mail className="w-4 h-4 sm:w-5 sm:h-5 text-[#4B5563]" />
              Thông báo email
            </div>
          ...
          <button
            ...
            className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors flex-shrink-0 ${emailNotifications ? "bg-[#4B5563]" : "bg-gray-300"
        ...
        <div className="border-2 border-[#4B5563]/15 rounded-lg md:rounded-xl p-4 md:p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 md:gap-4">
          <div className="flex-1 min-w-0">
            <div className="text-sm sm:text-base md:text-lg font-medium mb-1 flex items-center gap-2">
              <Lock className="w-4 h-4 sm:w-5 sm:h-5 text-[#4B5563]" />
              Đổi mật khẩu
            </div>
            <div className="text-xs sm:text-sm md:text-base text-gray-500">
          ...
          <button
            ...
            className="bg-[#4B5563] text-white px-4 py-2 md:px-6 md:py-2.5 rounded-lg md:rounded-xl text-xs sm:text-sm md:text-base font-semibold hover:bg-[#374151] transition-all duration-300 shadow-md hover:shadow-lg flex-shrink-0 w-full sm:w-auto"
          >
            Đổi mật khẩu
          </button>
        </div>
        ...
        <div className="border-2 border-[#4B5563]/15 rounded-lg md:rounded-xl p-4 md:p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 md:gap-4">
          <div className="flex-1 min-w-0">
            <div className="text-sm sm:text-base md:text-lg font-medium mb-1 flex items-center gap-2">
              <MapPin className="w-4 h-4 sm:w-5 sm:h-5 text-[#4B5563]" />
              Địa chỉ giao hàng
            </div>
            <div className="text-xs sm:text-sm md:text-base text-gray-500">
          ...
          <button
            ...
            className="px-4 py-2 md:px-6 md:py-2.5 rounded-lg md:rounded-xl text-xs sm:text-sm md:text-base font-semibold border-2 border-[#4B5563]/60 text-[#4B5563] bg-white hover:bg-[#4B5563]/5 transition-all duration-300 flex-shrink-0 w-full sm:w-auto"
          >
            Quản lý
          </button>
        </div>
