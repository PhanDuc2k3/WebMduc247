      ...
      <div className="p-4 sm:p-6 space-y-3 sm:space-y-4">
        {!showForm && (
          <button
            ...
            className="w-full px-4 sm:px-6 py-2.5 sm:py-3 bg-[#4B5563] text-white rounded-lg sm:rounded-xl font-bold hover:bg-[#374151] transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 flex items-center justify-center gap-2 text-sm sm:text-base"
          >
        ...
        {showForm && (
          <div className="bg-[#4B5563]/5 p-4 sm:p-6 rounded-xl sm:rounded-2xl border-2 border-[#4B5563]/40 animate-scale-in">
            <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full border-2 border-gray-200 rounded-lg sm:rounded-xl pl-10 sm:pl-12 pr-4 sm:pr-5 py-2.5 sm:py-3 text-sm sm:text-base focus:ring-2 focus:ring-[#4B5563] focus:border-[#4B5563] outline-none transition-all duration-300"
                  required
                />
              </div>
              <div className="relative">
              ...
              <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                <button
                  type="submit"
                  className="flex-1 px-4 sm:px-6 py-2.5 sm:py-3 bg-[#4B5563] text-white rounded-lg sm:rounded-xl font-bold hover:bg-[#374151] transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 text-sm sm:text-base flex items-center justify-center gap-2"
                >
        ...
        {addresses.length === 0 && !showForm ? (
          <div className="text-center py-8 sm:py-12 bg-[#4B5563]/5 rounded-xl sm:rounded-2xl border-2 border-gray-200">
          ...
          addresses.map((addr, index) => (
            <div
              ...
              className={`p-4 sm:p-6 space-y-2 sm:space-y-3 rounded-xl sm:rounded-2xl border-2 cursor-pointer transition-all duration-300 transform hover:scale-105 animate-fade-in-up ${
                selectedId === addr._id 
                  ? "border-[#4B5563] bg-[#4B5563]/5 shadow-lg" 
                  : "border-gray-300 hover:border-[#4B5563]/60 bg-white"
              }`}
