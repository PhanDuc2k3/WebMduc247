  ...
  if (returnStatus) {
    const statusMessages = {
      pending: {
        ...
        icon: AlertCircle,
        color: "text-[#4B5563]",
        bgColor: "from-[#4B5563]/10 to-[#4B5563]/5",
      ...
      <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg border-2 border-gray-100 overflow-hidden animate-fade-in-up">
        <div className="bg-[#4B5563]/5 p-4 sm:p-6 border-b-2 border-gray-200">
          <h2 className="text-xl sm:text-2xl font-bold text-[#4B5563] flex items-center gap-2 sm:gap-3">
            <RotateCcw size={20} className="sm:w-6 sm:h-6 text-[#4B5563]" />
            Trả lại hàng
          </h2>
        ...
        <div className="p-4 sm:p-6">
          <button
            ...
            className="w-full px-4 sm:px-6 py-2.5 sm:py-3 bg-[#4B5563] text-white text-sm sm:text-base font-bold rounded-lg sm:rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 hover:bg-[#374151] flex items-center justify-center gap-2"
          >
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-2xl max-w-md w-full p-6 animate-fade-in-up">
            ...
            <div className="mb-4">
              ...
              <textarea
                ...
                className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-[#4B5563] resize-none"
                rows={4}
                maxLength={500}
              />
              <div className="mt-1 flex justify-between items-center">
                <p className="text-xs text-gray-500">
                  {reason.length < 10 ? (
                    <span className="text-[#4B5563]">Cần ít nhất 10 ký tự (còn {10 - reason.length} ký tự)</span>
                  ) : (
