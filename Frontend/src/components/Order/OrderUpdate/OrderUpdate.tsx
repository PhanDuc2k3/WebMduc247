      ...
      <div className="p-4 sm:p-6 space-y-4 sm:space-y-5">
        ...
        <div>
          ...
          <select
            ...
            className="w-full border-2 border-gray-200 rounded-lg sm:rounded-xl px-3 sm:px-4 py-2.5 sm:py-3 text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-[#4B5563] focus:border-[#4B5563] transition-all duration-300"
          >
            {statusOptions.map((s) => (
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full border-2 border-gray-200 rounded-lg sm:rounded-xl px-3 sm:px-4 py-2.5 sm:py-3 text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-[#4B5563] focus:border-[#4B5563] transition-all duration-300 resize-none"
          />
        </div>
