      ...
      <div className="p-4 sm:p-6">
        <div className="flex items-start space-x-3 sm:space-x-4 mb-4 sm:mb-6">
          ...
          <div className="relative flex-shrink-0">
            <img
              ...
              alt="Avatar"
              className="w-16 h-16 sm:w-20 sm:h-20 rounded-full object-cover border-3 sm:border-4 border-[#4B5563] shadow-lg"
            />
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs sm:text-sm font-semibold px-2 sm:px-3 py-1 bg-[#4B5563]/10 text-[#4B5563] rounded-full inline-block mb-2 sm:mb-3">
              {customer.role}
            </p>
        ...
        <div className="flex flex-col space-y-2">
          <button
            ...
            className="w-full px-4 py-2.5 sm:py-3 bg-[#4B5563] text-white text-xs sm:text-sm font-bold rounded-lg sm:rounded-xl hover:bg-[#374151] transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 flex items-center justify-center gap-2"
          >
